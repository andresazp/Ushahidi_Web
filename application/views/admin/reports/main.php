				...
				<div class="tabs">
					...
					<div class="content-tab search-tab">
						...
						<?php
							...
							echo category::form_tree('c', array(), 1, TRUE, TRUE);
						?>
						</div>
						<div class="row location-row">
						<?php
							// Location
							echo form::label('radius', Kohana::lang('ui_main.location'));
						...
						<?php
							...
							echo "<label class='wrapped'>".form::checkbox('mode',1) . Kohana::lang('ui_main.web') . "</label>";
							echo "<label class='wrapped'>".form::checkbox('mode',2) . Kohana::lang('ui_main.sms') . "</label>";
							echo "<label class='wrapped'>".form::checkbox('mode',3) . Kohana::lang('ui_main.email') . "</label>";
							echo "<label class='wrapped'>".form::checkbox('mode',4) . Kohana::lang('ui_main.twitter') . "</label>";
						?>
						</div>
						<div class="row">
						<?php
							...
							echo "<label class='wrapped'>".form::checkbox('m',1) . Kohana::lang('ui_main.photos') . "</label>";
							echo "<label class='wrapped'>".form::checkbox('m',2) . Kohana::lang('ui_main.video') . "</label>";
							echo "<label class='wrapped'>".form::checkbox('m',4) . Kohana::lang('ui_main.reports_news') . "</label>";
						?>
						</div>
						<div class="row">
						<?php
							...
							echo "<label class='wrapped'>".form::radio('a',1) . Kohana::lang('ui_main.yes') . "</label>";
							echo "<label class='wrapped'>".form::radio('a',0) . Kohana::lang('ui_main.no') . "</label>";
						?>
						</div>
						<div class="row">
						<?php
							...
							echo "<label class='wrapped'>".form::radio('v',1) . Kohana::lang('ui_main.yes') . "</label>";
							echo "<label class='wrapped'>".form::radio('v',0) . Kohana::lang('ui_main.no') . "</label>";
						?>
						</div>
						<div class="row">
						<?php
