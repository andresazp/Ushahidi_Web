<div id="main" class="report_detail">
 ...
 <?php
			...
			<?php
				foreach ($incident_category as $category)
				{
				  ...
				  if ($category->category->category_image_thumb)
					{
					?>
					<a href="<?php echo url::site()."reports/?c=".$category->category->id; ?>"><span class="r_cat-box" style="background:transparent url(<?php echo url::base().Kohana::config('upload.relative_directory')."/".$category->category->category_image_thumb; ?>) 0 0 no-repeat;">&nbsp;</span> <?php echo $category->category->parent->category_title; ?>: <?php echo $category->category->category_title; ?></a>
					...
					{
					?>
					  <a href="<?php echo url::site()."reports/?c=".$category->category->id; ?>"><span class="r_cat-box" style="background-color:#<?php echo $category->category->category_color; ?>">&nbsp;</span> <?php echo $category->category->parent->category_title; ?><?php echo $category->category->category_title; ?></a>
				  <?php
				  }
				}
			?>
	...
	<div class="right-col">
		...
		<div class="report-print"><a href="#" onclick="window.print(); return false;" class="print"><?php echo Kohana::lang('printreport.print_report'); ?></a></div>
